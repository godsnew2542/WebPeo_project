                ...
                <?php
                    ...
                    if (!$result) {
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            echo '<td><input type="hidden" name="idu" value="'.$row['RID'].'">'."\n";
                            echo '<br><input name="smtUpdate'.$row['RID'].'" class="btn btn-primary" type="submit" value="Update" onClick="return confirmUpdate();">
