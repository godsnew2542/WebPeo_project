...
<body>
  ...
  if (isset($_SESSION['User'])) {
    ...
    <br> <br>
    <form center name="registration" action="Flight.php" method="post">
      <h1>Homepage</h1>
      ...
      <input name="Adult"  type="text" placeholder="5" required pattern="[\d0-9]{1}"> <br>
      <label for="RFname">เด็ก : </label>
      <input name="child"  type="text" placeholder="4" required pattern="[\d0-9]{1}">(3-14 ปี) <br><br>
      ชั้นที่นั่ง
      <select name="class">
